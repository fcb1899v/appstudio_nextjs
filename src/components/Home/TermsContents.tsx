...
/** Props for TermsContents. */
interface Props {
  isJa: boolean
}

/** Terms of service, privacy policy and cookie policy with smooth section scrolling. */
const TermsContents: NextPage<Props> = ({isJa}) => { 

  /** Smooth-scroll to the section named by the URL hash on load. */
  useEffect(() => {
...
/** Replaces the given words in text with <Link> elements. */
