...
/**
 * Signal app page component for app showcase and download
 * Displays comprehensive information about the Signal app including features,
...
const SignalPage: NextPage = () => {
  ...
  // App configuration and data for signal app
