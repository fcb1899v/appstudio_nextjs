...
/**
 * Japanese learning app page component for app showcase and download
 * Displays comprehensive information about the Japanese learning app including features,
...
const JapanesePage: NextPage = () => {
  ...
  // App configuration and data for japanese app
