...
/**
 * Allowance app page component for app showcase and download
 * Displays comprehensive information about the Allowance app including features,
...
const AllowancePage: NextPage = () => {
  ...
  // App configuration and data for allowance app
