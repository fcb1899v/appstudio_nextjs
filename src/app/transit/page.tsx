...
/**
 * Transit app page component for app showcase and download
 * Displays comprehensive information about the Transit app including features,
...
const TransitPage: NextPage = () => {
  ...
  // App configuration and data for transit app
